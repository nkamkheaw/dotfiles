...
[grid]
s0_put_center_key = <Control><Alt>k
s0_put_left_key = <Control><Alt>j
s0_put_right_key = <Control><Alt>l
s0_put_top_key = <Control><Alt>i
s0_put_bottom_key = <Control><Alt>comma
s0_put_topleft_key = <Control><Alt>u
s0_put_topright_key = <Control><Alt>o
s0_put_bottomleft_key = <Control><Alt>n
s0_put_bottomright_key = <Control><Alt>period
